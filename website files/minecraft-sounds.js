// Vanilla Minecraft Java sound IDs for autocomplete. IDs include the minecraft: namespace.
// Seeded from public Java sound event lists and expanded with common 1.20/1.21-era events.
window.MC_SOUND_IDS = Array.from(new Set([
